    ...
    fun loadVehicles() {
        ...
        viewModelScope.launch {
            try {
                ...
                MotiumApplication.logger.i("Loaded ${vehicleList.size} vehicles for user: $userId", "EnterpriseVehicleViewModel")
                ...
                viewModelScope.launch {
                    try {
                        ...
                        MotiumApplication.logger.w("Background vehicle sync failed: ${e.message}", "EnterpriseVehicleViewModel")
                    }
                }
            } catch (e: Exception) {
                MotiumApplication.logger.e("Error loading vehicles: ${e.message}", "EnterpriseVehicleViewModel", e)
