...
val enterpriseBottomNavItemsSimple = listOf(
    ...
    EnterpriseBottomNavItemSimple("enterprise_calendar", Icons.Filled.CalendarToday, Icons.Outlined.CalendarToday, "Calendar"),
    EnterpriseBottomNavItemSimple("enterprise_vehicles", Icons.Filled.DirectionsCar, Icons.Outlined.DirectionsCar, "Vehicles"),
...
fun EnterpriseBottomNavigationSimple(
    ...
    // Couleurs dynamiques basees sur le mode
